...
def find_best_hyperparameters_for_env(env, exploration, all_hyperparameters, num_iterations):
    ...
    json.dump(hist, open(f"results_baseline", 'w'))
    
    return best_hyperparameters

all_hyperparameters = {
    "schedule_timesteps": [5000, 10000, 20000, 50000, 100000],
    "final_p": [0.02],
    "initial_p": [1.0],
...
best_hyperparameters = find_best_hyperparameters_for_env("cartpole", "linear", all_hyperparameters, 5)
